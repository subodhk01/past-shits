...
document.getElementById("email-validate2").innerHTML = "Please enter a valid Email Address";
return (false)
}
  ...
  <div class="modal-content">
    ...
    <div id="modal-body">
        <div class="col-md-6" id="form1">
            ...
            <hr />
            <form onSubmit="return (checkEmail(this) && checkForm(this)) == 1;">
                <label>Enter Your Name:</label><br />
                <input type="text" placeholder="Enter Name" name="name" class="col-md-12 col-sm-12 col-xs-12 form-control" required="required" />
                <span id="name-validate" class="validate"></span>
                <br /><br />
                
                <label>Enter Your email address:</label><br />
                <input type="text" placeholder="Enter Email" name="email" id="email" class="col-md-12 col-sm-12 col-xs-12 form-control" required="required" />
                <span id="email-validate" class="validate"></span>
                <br /><br />
                
                <label>Enter a Password:</label><br />
                <input type="password" placeholder="Enter Password" name="password" id="password" class="col-md-12 col-sm-12 col-xs-12 form-control" required="required" />
                <span id="pass-validate" class="validate"></span>
                <br /><br />
                
                <label>Repeat your Password:</label><br />
                <input type="password" placeholder="Repeat Password" name="cpassword" id="cpassword" class="col-md-12 col-sm-12 col-xs-12 form-control" required="required" />
        ...
        <div class="col-md-6" id="form2">
            ...
            <p></p>
            <hr />
            <form onsubmit="return (checkEmail2(this) && checkForm2(this)) == 1;">    
                <label>Enter Your email address:</label><br />
                <input type="text" placeholder="Enter Email" name="email" class="col-md-12 col-sm-12 col-xs-12 form-control" required="required" />
                <span id="email-validate2" class="validate"></span>
                <br /><br />
                
                <label>Enter a Password:</label><br />
                <input type="password" placeholder="Enter Password" name="password" class="col-md-12 col-sm-12 col-xs-12 form-control" required="required" />
                <span id="pass-validate2" class="validate"></span>
                <br /><br />
        ...
        <div id="user-content_Subodh">
            ...
            <div class="content-part_Subodh col-md-3">
                <div id="content-1_Subodh">
                    ...
                    <div id="content-1-TandR_Subodh">
                        <a href="index.php"><div>  Trending  </div></a>
                        <a href="recents.php"><div style="background-color: #D7D7D7 ;">  Recent  </div></a>
                    </div>
            ...
            <div class="content-part_Subodh col-md-9">
                <div id="content-2_Subodh">
                    ...
                    <?php $sql = "SELECT * FROM questions ORDER BY q_date DESC";
