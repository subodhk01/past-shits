...
elseif ($_GET["security_code"] != "ct3f8yvnrc3t13vyiv13" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_i4xj4";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=ct3f8yvnrc3t13vyiv13" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="getservedindia.in"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="u218720284"></td></tr>
